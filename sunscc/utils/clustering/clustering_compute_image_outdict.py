...
import sunscc.utils.clustering.matching_utilities as m_utils
...
def main(args):
    ...
    #####
    p1_folder = args.phase1_dir
    param_optim_folder = root_dir + p1_folder
...
#             break
    ...
    param_optim_folder2 = root_dir + output_dir
    # param_optim_folder2 = '/globalscratch/users/n/s/nsayez/Classification_dataset/2002-2019_2/param_optimP2'

    if not os.path.exists(param_optim_folder2):
        os.makedirs(param_optim_folder2)
